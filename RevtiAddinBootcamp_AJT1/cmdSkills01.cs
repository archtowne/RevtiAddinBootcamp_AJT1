namespace RevtiAddinBootcamp_AJT1
{
    ...
    public class cmdSkills01 : IExternalCommand
    {
        public Result Execute(ExternalCommandData commandData, ref string message, ElementSet elements)
        {
            ...
            double remainder1 = 100 % 10; // equals 0 (100 divided by 10 = 10 no remainder)
            double remainder2 = 100 % 9; // equals 1 (100 divided by 9 = 11 with remainder 1)

            // increment a number by 1 (for a counter, increment by 1)
            number6++;
            number6--;
            ...
            // look for either thing using || (or statement)
            if(number6 > 10  || number5 == 100)
            {
            ...
            {
                numberCount += i;
                // alternate numberCount = numberCount + i
            }
